...
echo "<footer class=\"$className\"/>\n";?>
            ...
            <div class="col-md-7">
               <div class="row py-0">
                <div class="col-sm-1 hidden-md-down">
                  <a class="bg-circle bg-dark" href="index.php?page=contact">
                   <!-- <i class="fa fa-2x fa-fw fa-address-card"></i> -->
                    <i class="fa fa-2x fa-fw fa-solid fa-envelope"></i>
                  </a>
                </div>
                <div class="col-sm-11 text-white">
                <div><h4>  Contact</h4>
                    <p>   <span class="header-font">Online Fancy Store</span></p>
                </div>
            </div>
            </div>
        </div>
    ...
    <!--/.footer-->
<p class="text-center">'Online Fancy Store' E-Commerce Project Sixth Sem</p>
    <!--/.footer-bottom--> 